...
app.component('companyList', {
    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope, $location) {
        ...
        var dataTable = $('#companys_list').DataTable({
            ...
            stateLoadCallback: function(settings) {
                ...
                if (state_save_val) {
                    $('#search_company').val(state_save_val.search.search);
                }
            ...
            columns: [
                ...
                { data: 'code', name: 'companys.code' },
                { data: 'name', name: 'companys.name' },
                { data: 'mobile_no', name: 'companys.mobile_no' },
                { data: 'email', name: 'companys.email' },
            ],
        ...
        $scope.clear_search = function() {
            $('#search_company').val('');
            $('#companys_list').DataTable().search('').draw();
        }

        var dataTables = $('#companys_list').dataTable();
        ...
        $scope.deleteConfirm = function() {
            ...
            $http.get(
                ...
                if (response.data.success) {
                    ...
                    $('#companys_list').DataTable().ajax.reload(function(json) {});
...
app.component('companyForm', {
    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope) {
        get_form_data_url = typeof($routeParams.id) == 'undefined' ? company_get_form_data_url : company_get_form_data_url + '/' + $routeParams.id;
        var self = this;
        self.hasPermission = HelperService.hasPermission;
        ...
        $scope.onSelectedCountry = function(id) {
            company_get_state_by_country = vendor_get_state_by_country;
            $http.post(
                company_get_state_by_country, { 'country_id': id }
            ).then(function(response) {
                // console.log(response);
        ...
        $scope.onSelectedState = function(id) {
            company_get_city_by_state = vendor_get_city_by_state
            $http.post(
                company_get_city_by_state, { 'state_id': id }
            ).then(function(response) {
                // console.log(response);
